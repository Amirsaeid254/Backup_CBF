...
from backup_cbf.examples.inv_pend.backup_policies import PendulumBackupControl
from hocbf_composition.barriers.barrier import Barrier
from backup_cbf.examples.inv_pend.map_config import backup_barrier_functional
from backup_cbf.safe_controls.backup_safe_filter import MinIntervBackupSafeControl
...
Z_backup0 = backup_barriers[0].min_barrier(points)
Z_backup0 = Z_backup0.reshape(X.shape)
