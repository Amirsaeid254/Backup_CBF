...
# map_config = dict(
#     geoms=(
#         ('norm_box', AD(center=[2.5, 1.0], size=[3.0, 2.5])),
#         ('norm_box', AD(center=[-2.5, 2.5], size=[1.25, 1.25])),
#         ('norm_box', AD(center=[-5.0, -5.0], size=[1.875, 1.875])),
#         ('norm_box', AD(center=[5.0, -6.0], size=[3.0, 2.0])),
#         ('norm_box', AD(center=[-7.0, 5.0], size=[2.0, 3.0])),
#         ('norm_box', AD(center=[6.0, 7.0], size=[3.0, 1.0])),
